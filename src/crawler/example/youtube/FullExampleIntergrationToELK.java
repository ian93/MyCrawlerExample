...
public class FullExampleIntergrationToELK {
    ...
    static String elasticHost = "127.0.0.1" ;
    static String elasticPort = "9200" ;
    static String elasticIndex = "youtube-xiaoyu"; // 請在後方加入帳號(ex: youtube-abola)，務必全小寫字母
    static String elasticIndexType = "data"; // 範例請不要改這行

    // 設定使用者ID或頻道ID任一
    String username = "";
    String channelId = "UC24h-JBUHXT5HXIK_9cWOmQ";
